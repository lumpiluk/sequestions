...
\enquote{If you discovered that your belief was causing harm, would you be more open to re-examining it for accuracy?}            \end{center}
        ...
        \begin{flashcard}{
            ...
            \begin{center}
                \large
                    IL: \enquote{I just know my God exists.}                    % replace '/' with '\slash ' to allow line breaks for slashes
            \end{center}
            \vspace{\fill}
            \myfooter
            \vspace{-1.4ex}
...
\enquote{You don't accept my personal testimony of other people's personal testimonies, but you would like me to accept your personal testimony?}            \end{center}
        ...
        \begin{flashcard}{
            ...
            \begin{center}
                \large
                    IL: \enquote{If I was shown to be mistaken, I'd still believe it was true.}                    % replace '/' with '\slash ' to allow line breaks for slashes
            \end{center}
            \vspace{\fill}
            \myfooter
            \vspace{-1.4ex}
...
\enquote{Would you let a surgeon who also devalues truth to operate on your child?}            \end{center}
        ...
        \begin{flashcard}{
            ...
            \begin{center}
                \large
                    IL: \enquote{I feel sorry for lots of people when Judgement Day comes.}                    % replace '/' with '\slash ' to allow line breaks for slashes
            \end{center}
            \vspace{\fill}
            \myfooter
            \vspace{-1.4ex}
